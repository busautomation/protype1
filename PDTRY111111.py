...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        font.setBold(True)
        self.rtc_time_label.setFont(font)
...
"QTabBar::tab:selected { font: bold; color: skyblue; }")
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("music_4"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.playButton.setIcon(QIcon('logos/music_4.svg'))
        ...
        self.bt_play_pause_btn.setIcon(QIcon('logos/music_4.svg'))
        ...
        self.gate_open_button.setIcon(QIcon('phone_accept.png'))
        ...
        self.gate_close_button.setIcon(QIcon('phone_reject.png'))
        ...
        #color picker
        GPIO.setup(self.red,GPIO.OUT)                  #Set pin as GPIO out
        GPIO.setup(self.green,GPIO.OUT)                   #Set pin as GPIO in
        GPIO.setup(self.blue,GPIO.OUT)
        self.p1 = GPIO.PWM(self.red,50)
        self.p13 = GPIO.PWM(self.blue,50)
        self.p12 = GPIO.PWM(self.green,50)
        self.p1.start(0)
        self.p13.start(0)
        self.p12.start(0)
        self.color_picker_button = QtWidgets.QPushButton(self.setting_tab)
        self.color_picker_button.setGeometry(QtCore.QRect(30,220, 661, 71))
        font = QtGui.QFont()
        font.setPointSize(21)
        self.color_picker_button.setFont(font)
        self.color_picker_button.setStyleSheet("border:2px solid white;color:white;")
        self.color_picker_button.setIcon(icon11)
        self.color_picker_button.setIconSize(QtCore.QSize(60, 40))
        self.color_picker_button.setObjectName("color_picker_button")
        self.color_picker_button.clicked.connect(self.color_picker)#color picker button
        #britness picker

        GPIO.setup(self.led,GPIO.OUT)

        self.p = GPIO.PWM(self.led,50)
        self.p.start(0)
        self.slider=QtWidgets.QSlider(self.setting_tab)
        self.slider.setGeometry(QtCore.QRect(30,300, 661, 71))
        ...
        ###SSYS Exit
        self.sys_label = QtWidgets.QPushButton(self.stats_tab)
        self.sys_label.setGeometry(QtCore.QRect(30, 20, 661, 71))
        font = QtGui.QFont()
        font.setPointSize(21)
        self.sys_label.setFont(font)
        self.sys_label.setStyleSheet("border:2px solid white;color:white;")
        self.sys_label.setObjectName("person1_button_wakitaki")
        self.sys_label.clicked.connect(self.open_sys_label)
        ...
        for prop, value in changed.items():
            if prop == 'Status':
                ...
                if self.status == "playing":
                    self.bt_play_pause_btn.setIcon(QIcon('logos/music_3.svg'))
...
#####
    def addSound(self):
        ...
        # print(musiclist)
        dir_path = os.path.dirname("/media/pi/")
...
###########################################
    def playsong(self):
        ...
        if play == False:
            '''
              self.playButton.setIcon(QIcon('logos/music_3.svg'))
                elif self.status == "paused":
                    self.playButton.setIcon(QIcon('logos/music_4.svg'))
         1
            '''
...
#####
    ...
    def valuechange(self):
        ...
        self.p.ChangeDutyCycle(a)
        self.p1.ChangeDutyCycle(a)
        self.p12.ChangeDutyCycle(a)
        self.p13.ChangeDutyCycle(a)
        time.sleep(0.003)
    def run(self):
        print("clicked")
        a=time.strftime("%d:%m:%y  %H:%M:%S")
    ...
    def color_picker(self):
        ...
        print(self.get_color.name())
        color=str(self.get_color.name())
        color=color[1:]
        rgb=[]
        for i in (0,2,4):
        ...
        x = ((x - oldm)/(oldma - oldm))*(newma - newm) + newm
        y=((y - oldm)/(oldma - oldm))*(newma - newm) + newm
        z=((z - oldm)/(oldma - oldm))*(newma - newm) + newm
        self.p1.ChangeDutyCycle(x)
        self.p12.ChangeDutyCycle(y)
        self.p13.ChangeDutyCycle(z)
    ...
    def retranslateUi(self, MainWindow):
        ...
        #p3.start()
        #p3.join()
        self.color_picker_button.setText(_translate("MainWindow", "Color Picker"))
